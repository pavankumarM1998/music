let playlist = [ {
  'title': 'Taylor_Swift_-_Delicate \n artist:Tylor swift',
  'audio': "assets/Taylor_Swift_-_Delicate.mp3",
  
}, 
{
  'title': 'Justin_Bieber_-_Yummy \n artist:Justin bieber',
  'artist':'Justn bieber',
  'audio': "assets/Justin_Bieber_-_Yummy.mp3",
}, 
{
  'title': 'Lost_Sky_-_Where_We_Started \n artist:Reddening west',
  'audio': "assets/Lost_Sky_-_Where_We_Started.mp3",
},
{
  'title': 'Luis_Fonsi_-_Despacito_ft._Daddy_Yankee \n artist:Lusi fonsi',
  'audio': "assets/Luis_Fonsi_-_Despacito_ft._Daddy_Yankee.mp3",
},
{
  'title': 'Spider-Man_Trilogy_Music_Superhero \n artist:Michael buble',
  'audio': "assets/Spider-Man_Trilogy_Music_Superhero.mp3",
},
{
  'title': 'Tears For Fears - Everybody Wants To Rule The World  \n artist:Tear for fears',
  'audio': "assets/Tears For Fears - Everybody Wants To Rule The World.mp3",
}, 
{
  'title': 'Unknown_Brain_-_Superhero\n artist:Unknown brain',
  'audio': "assets/Unknown_Brain_-_Superhero.mp3",
} 
];
i = 0;
n = playlist.length;
...
$( "#pavan" ).data( 'dir', 1 );
$( '#pavan' ).on( 'click', function( ) {
  i = ( i + $( this ).data( 'dir' ) + n+1 ) % n;
  console.log( i );
  player.src = playlist[ i ].audio;
  $( '.title' ).html( playlist[ i ].title );
  $( '#play-btn' ).removeClass( "fa-play" );
